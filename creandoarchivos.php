  ...
  include_once'generandovistas1.php';
  ...
  if(isset($_POST["btenviar"])){
	  ...
	  if(count($sele)>0){
		  $consulta="Select ";
		   $verre=false;$arraytabla=array();$arrayenlace=array();$arrayva=array();$arraycabeza=array();$arrayenlace2=array();
		  for($i=0;$i<count($sele);$i++){ 
			...
			if($tabla!=$_POST["ttabla".$romper[1]]){
				  ...
				  $arrayva[]=$romper[0];
				  $consulta.=$_POST["ttabla".$romper[1]].".".$capturarenlace[1]." As '" .$_POST["tmostrar".$romper[1]]."',";$arraycabeza[]=$_POST["tmostrar".$romper[1]];
				  }
				  else{
