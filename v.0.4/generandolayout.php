...
function generandolayout()
{
    ...
    $texto .= '     <h3>PHPERU - APLICACIONES PHP-MVC CREATED BY <a href="https://twitter.com/armandoaepp" target="_blank">@armandoaepp</a></h3>' . PHP_EOL ;   
    ...
    $texto .= '         <li><a href="?accion=Exportar&type=pdf" class="btn" target="_blank"><i class="icon-pdf"></i></a></li>' . PHP_EOL;
    $texto .= '         <li><a href="?accion=Exportar&type=xls" class="btn"><i class="icon-excel"></i></a></li>' . PHP_EOL;
    $texto .= '         <li><a href="?accion=Exportar&type=doc" class="btn"><i class="icon-word"></i></a></li>' . PHP_EOL;
    $texto .= '         <li><a href="?accion=Exportar&type=html" class="btn"><i class="icon-html"></i></a></li>' . PHP_EOL;
