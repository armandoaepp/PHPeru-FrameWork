<div id="divRegistrar_peparparametro">
<form id="frmRegistrar_peparparametro" name="frmRegistrar_peparparametro" class="hform" method="post" action="<?php echo $accionf;?>">
<fieldset> <legend> Nuevo Peparparametro</legend>
