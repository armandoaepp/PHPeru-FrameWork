...
<p><label for="DistritoId_">DistritoId : </label><input type="text" name="DistritoId_" id="DistritoId_" value=""/></p>
<p><label for="DistritoNombre_">DistritoNombre : </label><input type="text" name="DistritoNombre_" id="DistritoNombre_" value=""/></p>
<p><label for="ProvinciaId_">ProvinciaId : </label><input type="text" name="ProvinciaId_" id="ProvinciaId_" value=""/></p>
<p><label for="UbigeoDist_">UbigeoDist : </label><input type="text" name="UbigeoDist_" id="UbigeoDist_" value=""/></p>
