...
<fieldset><label for="TextoTitulo_">Titulo : </label><input type="text" name="TextoTitulo_" id="TextoTitulo_" value=""/></fieldset>
<fieldset><label for="Texto_">Texto : </label>
	<textarea name="Texto_" id="Texto_" > </textarea>
	<!-- <input type="text" name="Texto_" id="Texto_" value=""/></fieldset> -->
<fieldset><label for="SimulacroId_">SimulacroId : </label><input type="text" name="SimulacroId_" id="SimulacroId_" value=""/></fieldset>
<fieldset><label for="TextoEstado_">Estado : </label><input type="text" name="TextoEstado_" id="TextoEstado_" value=""/></fieldset>
