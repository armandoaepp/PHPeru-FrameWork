...
case "Actualizar":
  ...
  $PersonaApellido=$rptamo["cuerpo"][0]["PersonaApellido"];
  $PersonaNombre=$rptamo["cuerpo"][0]["PersonaNombre"];
  $PersonaEmail=$rptamo["cuerpo"][0]["PersonaEmail"];
  $PersonaTelefono=$rptamo["cuerpo"][0]["PersonaTelefono"];
