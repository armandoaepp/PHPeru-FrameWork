...
public function setClienteDirerccion($ClienteDirerccion_){ $this->ClienteDirerccion=$ClienteDirerccion_;}
public function getClienteDirerccion(){ return $this->ClienteDirerccion;}
...
$con=new Conexion();
$consulta="Insert into cliente values('$this->ClienteId','$this->ClienteNombre','$this->ClienteDirerccion','$this->ClienteRepresentante','$this->ClienteEmail','$this->ClienteFax','$this->ClienteDireccion','$this->ClienteCodigoPostal','$this->ClienteNota','$this->ClienteTelefono','$this->ClienteMovil','$this->PaisId')";
...
include_once 'conexion.php';
$con=new Conexion();
$consulta="Select cliente.ClienteId As 'ClienteId',cliente.ClienteNombre As 'Nombre',cliente.ClienteDirerccion As 'Direrccion',cliente.ClienteRepresentante As 'Representante',cliente.ClienteEmail As 'Email',cliente.ClienteFax As 'Fax',cliente.ClienteDireccion As 'Direccion',cliente.ClienteCodigoPostal As 'Codigo Postal',cliente.ClienteNota As 'Nota',cliente.ClienteTelefono As 'Telefono',cliente.ClienteMovil As 'Movil',cliente.PaisId As 'PaisId' from cliente";
