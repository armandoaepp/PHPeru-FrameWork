...
function generandoIndex($atri, $cabeza, $tabla, $tablaref, $arrayenlace, $arrayenlace2)
{
    ...
    if (!empty($tabla)) {
        ...
        $texto .= '    $'.$tabla.'Controller = new '.$tabla.'Controller() ; ' . PHP_EOL;
        $texto .= '    $data = $'.$tabla.'Controller->c_get_'.$tabla.'() ;' . PHP_EOL;
        ...
        $texto .= '    $'.$tabla.'Controller = new '.$tabla.'Controller() ; ' . PHP_EOL;
        $texto .= '    $data = $'.$tabla.'Controller->c_set_'.$tabla.'() ;' . PHP_EOL;
        $texto .= '    $jsn  = json_encode($data);' . PHP_EOL;
        $texto .= '    print_r($jsn) ;' . PHP_EOL;
        $texto .= 'break;' . PHP_EOL;
        $texto .= "" . PHP_EOL;
        ...
        $texto .= '    $'.$tabla.'Controller = new '.$tabla.'Controller() ; ' . PHP_EOL;
        $texto .= '    $data = $'.$tabla.'Controller->c_get_'.$tabla.'_id'.$tabla.'( $id) ;' . PHP_EOL;
        $texto .= '    $jsn  = json_encode($data);' . PHP_EOL;
        $texto .= '    print_r($jsn) ;' . PHP_EOL;
        $texto .= 'break;' . PHP_EOL;
        $texto .= "" . PHP_EOL;
        ...
        $texto .= '    $'.$tabla.'Controller = new '.$tabla.'Controller() ; ' . PHP_EOL;
        $texto .= '    $data = $'.$tabla.'Controller->c_upd_'.$tabla.'() ;' . PHP_EOL;
        $texto .= '    $jsn  = json_encode($data);' . PHP_EOL;
        $texto .= '    print_r($jsn) ;' . PHP_EOL;
        $texto .= 'break;' . PHP_EOL;
        $texto .= "" . PHP_EOL;
