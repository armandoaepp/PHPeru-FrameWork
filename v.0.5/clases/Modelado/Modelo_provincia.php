...
$con=new Conexion();
$consulta="Insert into provincia values('$this->nProCodigo','$this->cProDescripcion','$this->nDepCodigo','$this->nProEstado')";
...
include_once 'conexion.php';
$con=new Conexion();
$consulta="Select provincia.nProCodigo As 'nProCodigo',provincia.cProDescripcion As 'cProDescripcion',provincia.nDepCodigo As 'nDepCodigo',provincia.nProEstado As 'nProEstado' from provincia";
...
include_once 'conexion.php';
$con=new Conexion();
$consulta="UPDATE provincia SET cProDescripcion='$this->cProDescripcion',nDepCodigo='$this->nDepCodigo',nProEstado='$this->nProEstado' WHERE nProCodigo='$this->nProCodigo'";
$rpta=$con->MetodoRegistrar($consulta);
