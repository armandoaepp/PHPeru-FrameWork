...
$nomarchivo=$carpeta."index";
	...
	$texto.='//Armando Enrique Pisfil Puemape '.PHP_EOL;
    ...
    $texto.='         }else{'.PHP_EOL;	
     $texto.='         $busca=""; }'.PHP_EOL;
	 $texto.='*/'.PHP_EOL;			 
	$texto.='      $Listar_'.$tabla.'=$cix->ImprimeTableP("tabla'.$tabla.'",$data,"?","?",10,$page,5,"tabla");'.PHP_EOL;
	$texto.='   // $Listar_'.$tabla.'=$cix->ImprimeTablePOB("tabla'.$tabla.'",$data,"?","?",10,$page,5,$orden,$buscar,"tabla");'.PHP_EOL;
